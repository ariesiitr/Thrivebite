const getValue=(foodname)=>{


fetch('https://api.nal.usda.gov/fdc/v1/foods/search?query='+foodname+'&pageSize=2&api_key=fCCNF4Q4dsZXLBTu95QN3zBgH8brFaH6fasNRnUt')
	.then(response => response.json())
	.then(response => {

 var proteins = response['foods'][0]['foodNutrients'][0]['value'] ;
    var fats = response['foods'][0]['foodNutrients'][1]['value'] + ' '+ response['foods'][0]['foodNutrients'][1]['unitName'];
    var calories = response['foods'][0]['foodNutrients'][3]['value'] + ' '+ response['foods'][0]['foodNutrients'][3]['unitName'];
	console.log('proteins: ' + proteins);
    console.log('fats: '+ fats);
    console.log('calories: ' + calories);


temp.innerHTML=calories;
humidity.innerHTML=fats;

wind_speed.innerHTML=proteins;
...
function calc() {
    ...
    document.getElementById("Final").style = "max-width: 25rem; margin: auto; border: 6px solid orange; width: 50%; margin-top: 45px; background-color:white; border-radius: 20px; color:grey; margin-bottom: 30px"
}
